...
class PositionalEmbedding(nn.Module):
    def __init__(self, d_model, max_len=5000):
        ...
        # pe shape:  torch.Size([1, 5000, 512])
...
class DataEmbedding(nn.Module):
    ...
    def forward(self, x, x_mark):
        # valemb = self.value_embedding(x)
        # posemb = self.position_embedding(x)
        # tmpemb = self.temporal_embedding(x_mark)
        # print(valemb.shape)
        # print(posemb.shape)
        # print(tmpemb.shape)
        # x = valemb + posemb + tmpemb
